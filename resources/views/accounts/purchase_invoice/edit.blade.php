...
<div x-data="invoiceAdd" class="pX-5 panel w-full">
  <form class="form-horizontal"  id="edit_purchase_invoice" name="edit_purchase_invoice" action="{{ route('purchase_invoice_account_update',$result->account_id) }}" method="POST" enctype="multipart/form-data">
		@csrf
    <div class="mt-8 px-4">
