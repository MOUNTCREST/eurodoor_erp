...
<form class="form-horizontal"  id="add_purchase_invoice" name="add_purchase_invoice" action="{{ url('purchase_invoice_account') }}" method="POST" enctype="multipart/form-data" onsubmit="return disableSubmitButton()">
					@csrf
<div class="mt-8 px-4">
                                    <div class="flex flex-col justify-between lg:flex-row">
                                        ...
                                        <div class="mt-3 flex items-center">
                                                ...
                                                <input type="text" id="p_i_no"  class="form-input flex-1"  placeholder="" name="p_i_no" autocomplete="off" value="{{old('p_i_no')}}" required='required'>
                                        ...
                                        <div class="mb-6 w-full lg:w-1/2 ltr:lg:mr-6 ">
                                            ...
                                            <div class="mt-3 flex items-center">
                                                ...
                                                <input type="date" required='required' id="p_date" value="{{date('Y-m-d')}}" max='<?php echo date("Y-m-d"); ?>'  class="form-input flex-1" placeholder="" name="p_date" autocomplete="off">
                                  @error('p_date')
                                    <small class='text-danger'>{{ $message }}</small>
                                  @enderror
                                ...
                                <div>
                                    ...
                                    <div class="mb-6 w-full lg:w-1/2 ltr:lg:mr-6 rtl:lg:ml-6">
                                            ...
                                            <div class="mt-3 flex items-center">
                                               ...
                                               <label for="ref_no" class="mb-0 w-1/5 ltr:mr-2 rtl:ml-2">Supplier<span style="color: #EB2D30">*</span></label>
                                                 
                                              <select id="supplier_id" name="supplier_id" class="form-input flex-1"
                                              required='required'>
                                                                  <option  value="" >Select</option>
                                                                      @foreach ($supplier_lists as $row)
                                                                          <option value="{{ $row->ledger_id; }}" {{ old('supplier_id') == $row->ledger_id ? 'selected' : '' }}>{{ $row->supplier_name; }}</option>
                                                                      @endforeach
                                                                  </select>
                                              @error('supplier_id')
                                                <small class='text-danger'>{{ $message }}</small>
 ...
 <div x-data="modal" >
  ...
  <!-- </form>  -->
                                        ...
                                        <div class="mt-2 flex items-center">
                                            ...
                                            class="form-textarea min-h-[50px] flex-1" readonly="readonly"
                                        ...
                                        <option  value="" selected>Select</option>
                                            @foreach ($p_a_lists as $row)
                                                <option value="{{ $row->id; }}" {{ $row->ledger == 'LOCAL PURCHASE' ? 'selected' : '' }}>{{ $row->ledger; }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="">
                                <table id="tbl_items" class="item_tbl">
                                            <thead>
                                                    <tr>
                                                ...
                                                <tbody id="tbody" style=" padding: 0.35rem 0.2rem !important;">
                                                  <tr id="R1" style=" padding: 0.35rem 0.2rem !important;">
                                                    <td style=" padding: 0.35rem 0.2rem !important;"><h6 class="text-center">1</h6></td>
                                                    <td width="200" style=" padding: 0.35rem 0.2rem !important;">
                                                    ...
                                                    <td style=" padding: 0.35rem 0.2rem !important;">
                                                      <input type="number" class="form-input" name="white_amount[]" autocomplete="off" id="white_amount1"  step="0.00001"  oninput="calculate(1);" required="required">
                                                      <input type="hidden" class="form-input white_amount" name="white_amount_qty[]" autocomplete="off" id="white_amount_qty1"  step="0.00001"  value="0"  >
                                                    </td>
                                                    <td style=" padding: 0.35rem 0.2rem !important;">
                                                    ...
                                                    <td style=" padding: 0.35rem 0.2rem !important;">
                                                      <input type="number" class="form-input" name="black_amount[]" autocomplete="off" id="black_amount1"  step="0.00001"   oninput="calculate(1);" required="required">
                                                      <input type="hidden" class="form-input black_amount" name="black_amount_qty[]" autocomplete="off" id="black_amount_qty1"  step="0.00001"  >
                                                    </td>
                                                    <td style=" padding: 0.35rem 0.2rem !important;">
                                                      <input type="number" class="form-input amount" name="amount[]" autocomplete="off" id="amount1"  step="0.00001"    required="required">
                                                    </td>
                                                    <td style=" padding: 0.35rem 0.2rem !important;" class="text-center">
                                                      <button type="button" >
...
$(document).ready(function(){
  $("#supplier_id").change(function(){
    ...
    $.ajax({
				url: '{{route('get_supplier_address_account')}}',
				type: 'GET',
...
$(document).ready(function(){
  $("#supplier_btn").click(function(){
    ...
    if((supplier_name === "") && (supplier_name === "") && (supplier_name === "")){
      alert("Please Fill Required Fields")
    }
    else{
      $.ajax({
				url: '{{route('save_supplier_details_account')}}',
				type: 'GET',
...
<script>
  function get_supplier_list(){
    $.ajax({
				url: '{{route('get_supplier_list_account')}}',
				success: function(data) {
...
<script>
       document.addEventListener('DOMContentLoaded', function () {
        ...
        const myForm = document.getElementById('add_purchase_invoice');
