...
<div x-data="invoicePreview">
                        ...
                        <div class="mb-6 flex flex-wrap items-center justify-center gap-4 lg:justify-end">
                            ...
                            <a href="{{ route('purchase_invoice_account_create')}}" class="btn btn-secondary gap-2">
                                <svg
                            ...
                            <a href="{{ route('purchase_invoice_account_edit',$result->id) }}" class="btn btn-warning gap-2">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5">
                                    <path
                                        opacity="0.5"
                        ...
                        <div class="panel">
                            <div class="flex flex-wrap justify-between gap-4 px-4">
                                <div class="text-2xl font-semibold uppercase">Purchase Invoice</div>
                                <div class="shrink-0">
                            ...
                            <div class="flex flex-col flex-wrap justify-between gap-6 lg:flex-row">
                                <div class="flex-1">
                                    <div class="space-y-1 text-white-dark">
                                        <div>Supplier:</div>
                                        <div class="font-semibold text-black dark:text-white">{{$result->supplier_name}}</div>
                                ...
                                <div class="flex flex-col justify-between gap-6 sm:flex-row lg:w-2/3">
                                    ...
                                    <div class="mb-2 flex w-full items-center justify-between">
                                            <div class="text-white-dark">Reference No :</div>
                                            <div>{{$result->ref_no;}}</div>
                                        </div>
                                        <div class="mb-2 flex w-full items-center justify-between">
                                            <div class="text-white-dark">Invoice No :</div>
                                            <div>{{$result->p_i_no;}}</div>
                                        </div>
                                        <div class="mb-2 flex w-full items-center justify-between">
                                            <div class="text-white-dark">Invoice Date :</div>
                                            <div>{{$result->p_date;}}</div>
                                        </div>
                                    
                                    </div>
                                    <div class="xl:1/3 sm:w-1/2 lg:w-2/5">
                                    <div class="mb-2 flex w-full items-center justify-between">
                                            <div class="text-white-dark">Purchase Account</div>
                                            <div class="whitespace-nowrap">{{$result->ledger}}</div>
                                        </div>
                                        <div class="mb-2 flex w-full items-center justify-between">
                            ...
                            <div class="table-responsive mt-6">
                                <table >
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$p_item->unit_name;}}</td>
                                        <td>{{$p_item->qty;}}</td>
                                        <td>{{$p_item->white_amount;}}</td>
                                        <td>{{$p_item->gst;}}</td>
                                        <td>{{$p_item->black_amount;}}</td>
                                        <td>{{$p_item->amount;}}</td>
                                    </tr>
                                    @endforeach
                                    </tbody>
                            ...
                            <div class="mt-6 grid grid-cols-1 px-4 sm:grid-cols-2">
                                ...
                                <div class="space-y-2 ltr:text-right rtl:text-left">
                                    <div class="flex items-center">
                                        <div class="flex-1">W Amount Total</div>
                                        <div class="w-[37%]">{{$result->w_a_total;}}</div>
                                    </div>
                                    <div class="flex items-center">
                                        <div class="flex-1">Gst</div>
                                        <div class="w-[37%]">{{$result->gst_total;}}</div>
                                    </div>
                                    <div class="flex items-center">
                                        <div class="flex-1">B Amount Total</div>
                                        <div class="w-[37%]">{{$result->b_a_total;}}</div>
                                    </div>
                                    
                                    <div class="flex items-center text-lg font-semibold">
                                        <div class="flex-1">Grand Total</div>
                                        <div class="w-[37%]">{{$result->total;}}</div>
                                    </div>
                                </div>
                            </div>
                            <div class="mt-6 flex flex-cols-1 px-4 sm:flex-cols-2">
                               
                                    <div class="flex items-center text-lg font-semibold">
                                        <div class="flex-1">Grand Total = </div>
                                        <div class="w-[100%]">{{$result->total;}}</div>
                                    </div>
                                </div>
                            </div>
                        </div>
