...
<!-- start main content section -->
						<!-- <ul class="flex space-x-2 rtl:space-x-reverse">
                            <li>
                                <a href="{{ route('contra_list')}}" class="text-primary hover:underline">Contra</a>
                            </li>
                            <li class="before:content-['/'] ltr:before:mr-1 rtl:before:ml-1">
                                <span><a href="{{ route('contra_create')}}" class="text-primary hover:underline">Create</a></span>
                            </li>
                        </ul> -->
						...
						<div class="pX-5 panel w-full">
						  ...
						  <div class="container">
							 <div class="row">
							 <div class="col-sm-12">
							 <form class="form-horizontal"  id="add_contra" name="add_contra" action="{{ url('contra_account') }}" method="POST" enctype="multipart/form-data" onsubmit="return disableSubmitButton()">
					@csrf
						<div class="form-body">
							...
							<div class="form-group col-sm-4">
                                ...
                                <div class="form-group col-sm-12">
									...
									<textarea class="form-input" name="narration" id="narration">{{old('amount')}}</textarea>
