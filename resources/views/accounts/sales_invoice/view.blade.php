...
<div x-data="invoicePreview">
                        ...
                        <div class="mb-6 flex flex-wrap items-center justify-center gap-4 lg:justify-end">
                            ...
                            <a href="{{ route('sales_invoice_account_download',$result->id)}}" class="btn btn-success gap-2">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5">
                                    <path
                                        opacity="0.5"
                            ...
                            <a href="{{ route('sales_invoice_account_create')}}" class="btn btn-secondary gap-2">
                                <svg
                            ...
                            <a href="{{ route('sales_invoice_account_edit',$result->id) }}" class="btn btn-warning gap-2">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5">
                                    <path
                                        opacity="0.5"
                        ...
                        <div class="panel">
                            <div class="flex flex-wrap justify-between gap-4 px-4">
                                <div class="text-2xl font-semibold uppercase">Sales Invoice</div>
                                <div class="shrink-0">
                                ...
                                <div class="flex flex-col justify-between gap-6 sm:flex-row lg:w-2/3">
                                    <div class="xl:1/3 sm:w-1/2 lg:w-2/5">
                                        <div class="mb-2 flex w-full items-center justify-between">
                                            ...
                                            <div>{{$result->s_i_no;}}</div>
                                        </div>
                                        <div class="mb-2 flex w-full items-center justify-between">
                                            <div class="text-white-dark">Invoice Date :</div>
                                            <div>{{$result->s_date;}}</div>
                                        </div>
                                    
                                    </div>
                                    <div class="xl:1/3 sm:w-1/2 lg:w-2/5">
                                    <div class="mb-2 flex w-full items-center justify-between">
                                            <div class="text-white-dark">Sales Account</div>
                            ...
                            <div class="table-responsive mt-6">
                                <table >
                                    ...
                                    <tr>
                                        <td>{{$no++}}</td>
                                        <td>{{$s_item->product_name;}}</td>
                                        <td>{{$s_item->unit_name;}}</td>
                                        <td>{{$s_item->qty;}}</td>
                                        <td>{{$s_item->white_amount;}}</td>
                                        <td>{{$s_item->gst;}}</td>
                                        <td>{{$s_item->black_amount;}}</td>
                                        <td>{{$s_item->amount;}}</td>
                                    </tr>
                                    @endforeach
                                    </tbody>
