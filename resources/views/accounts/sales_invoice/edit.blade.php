...
<div x-data="invoiceAdd" class="pX-5 panel w-full">
  <form class="form-horizontal"  id="edit_sales_invoice" name="edit_sales_invoice" action="{{ route('sales_invoice_account_update',$result->account_id) }}" method="POST" enctype="multipart/form-data">
		@csrf
    <div class="mt-8 px-4">
    ...
    <div class="flex flex-col justify-between lg:flex-row">
                                        <div class="mb-6 w-full lg:w-1/2 ltr:lg:mr-6 ">
                                            ...
                                            <div class="mt-3 flex items-center">
                                                ...
                                                <select id="sale_type" name="sale_type" class="form-input flex-1" onchange="return get_order_no();">
                                                  <option value="">Select</option>
    ...
    $(document).ready(function () {
      ...
      $('#addBtn').on('click', function () {
        ...
        $('#tbody').append(`<tr id="R${++rowIdx}"><td class="text-center" style=" padding: 0.35rem 0.2rem !important;">${rowIdx}</td>
                                                    ...
                                                    <td style=" padding: 0.35rem 0.2rem !important;">
                                                      <input type="number" class="form-input amount" name="amount[]" id="amount${rowIdx}"  oninput="calculate(${rowIdx});" autocomplete="off"  step="0.00001" >
                                                    </td>
                                                    <td class="text-center" style=" padding: 0.35rem 0.2rem !important;">
                                                    <button type="button" class="remove" >
