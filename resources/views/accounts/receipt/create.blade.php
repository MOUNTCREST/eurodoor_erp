...
<!-- start main content section -->
						...
						<div class="pX-5 panel w-full">
						  ...
						  <div class="container">
							 <div class="row">
							 <div class="col-sm-12">
							 <form class="form-horizontal"  id="add_receipt" name="add_receipt" action="{{ url('receipt_account') }}" method="POST" enctype="multipart/form-data" onsubmit="return disableSubmitButton()">
					@csrf
						<div class="form-body">
