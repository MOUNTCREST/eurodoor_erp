...
<div x-data="">
                        ...
                        <div class="mb-6 flex flex-wrap items-center justify-center gap-4 lg:justify-end">
                            ...
                            <a href="{{ route('measurement_form_edit_confirmation',$result->id) }}" class="btn btn-warning gap-2">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5">
                                    <path
                                        opacity="0.5"
                        ...
                        <table style="width:100%" class="table-bordered ">
                            <tr>
                                <td colspan="3" class="text-center"><div class="text-2xl font-semibold uppercase">CONFIRMED ORDER</div></td>
                                <td>Order Date : {{$result->order_date;}} </td>
                            </tr>
                            <tr>
                                <td>Shop Name & Address : {{$result->site_name}} </br>  {{$result->site_address}}  </td>
                                <td>Customer Name & Address : {{$result->customer_name}} </br> {{$result->brand}} </br> {{$result->permenant_address}}</td>
