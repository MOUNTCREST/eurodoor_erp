...
<form class="form-horizontal"  id="add_measurement_form" name="add_measurement_form" action="{{ url('measurement_form_packing') }}" method="POST" enctype="multipart/form-data" onsubmit="return disableSubmitButton()">
					@csrf
						<div class="form-body">
				
							<div class="row">
                            <div class="form-group col-sm-3">
									<label for="fitting_or_packing">Packing<span style="color: #EB2D30">*</span> </label>
                                    <input type="text" id="fitting_or_packing"  class="form-input" placeholder=" " value="Packing"  name="fitting_or_packing" readonly="readonly" autocomplete="off">
								</div> 
								<div class="form-group col-sm-3">
									...
									<label for="executive">Executive<span style="color: #EB2D30"></span> </label>
										<select id="executive" name="executive" class="form-input" >
                                            ...
                                            @foreach ($executive_lists as $row)
                                                <option value="{{ $row->id; }}" {{ old('executive') == $row->id ? 'selected' : '' }}>{{ $row->name; }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="p-4">
                                       ...
                                       <div>
                                                ...
                                                <select id="type_pop_up" name="type_pop_up" class="form-input" onchange="return type_change();">
                                                        ...
                                                        <option val="Door Only Without Clearence">Door Only Without Clearence</option>
                                        ...
                                        <div id="door_thickness_div">
                                                ...
                                                <select id="door_thickness_popup" name="door_thickness_popup" class="form-input">
                                                        <option val="">Select</option>
                                        ...
                                        <div id="lock_measurement_div">
                                            ...
                                            <div id="item_remarks_div">
                                                <label for="item_remarks_pop_up">Remarks<span style="color: #EB2D30"></span> </label>
                                                <input type="text" name="item_remarks_pop_up" id="item_remarks_pop_up" class="form-input">
                                            </div>
 ...
 function type_change(){
    ...
    $("#lock_measurement_div").show();
     if((type_pop_up == 'Door Only') || (type_pop_up == 'Door Only Without Clearence')){
       ...
       $('#frame_pop_up').append('<option value="Wood">Wooden</option>');
       $('#frame_pop_up').append('<option value="Fiber">Fiber</option>');
...
<script>
    function get_color_type_and_color_by_model(){
        ...
        $.ajax({
				url: '{{route('get_color_type_and_color_name_packing')}}',
...
$.ajax({
        url: '{{route('get_top_width_clearence_door_only_packing')}}',
        type: 'GET',
        success: function(data) {
        ...
        $.ajax({
                url: '{{route('get_top_width_clearence_packing')}}',
                type: 'GET',
...
<script>
    $("#color_type_pop_up").change(function(){
		...
		$.ajax({
				url: '{{route('get_color_list_packing')}}',
				type: 'GET',
...
$("#m_w_c_h_pop_up").val("0");
    ...
    if(frame_pop_up == 'Fiber'){
        ...
        // $("#h_m_div").hide();
        $.ajax({
				url: '{{route('get_frame_size_deatils_packing')}}',
				type: 'GET',
				success: function(data) {
...
function get_sub_models(){
    ...
    model_id = $("#model_pop_up").val();
		...
		$.ajax({
				url: '{{route('get_sub_models_packing')}}',
				type: 'GET',
				data: {model_id: model_id},
				success: function(data) {
...
function get_details_of_sub_model(){
    sub_model_id = $("#sub_model_pop_up").val();
		...
		$.ajax({
				url: '{{route('get_details_of_sub_model_packing')}}',
				type: 'GET',
            ...
            function get_color_type_details(){
                ...
                $.ajax({
                        url: '{{route('get_color_type_details_packing')}}',
                        type: 'GET',
                        data: {model_id: model_id},
                        success: function(data) {
...
$(document).ready(function(){
  $("#customer_id").change(function(){
    ...
    $.ajax({
				url: '{{route('get_customer_deatils_packing')}}',
				type: 'GET',
...
$(document).ready(function(){
    ...
    $.ajax({
				url: '{{route('generate_order_no_packing')}}',
				type: 'GET',
...
<script>
    function check_items(order_no){
        $.ajax({
				url: '{{route('check_in_measurement_items_packing')}}',
				type: 'GET',
...
<script>
    ...
    <script>
        ...
        item_remarks = $("#item_remarks_pop_up").val();
        door_thickness = $("#door_thickness_popup").val();

        $.ajax({
				url: '{{route('save_as_tem_data_m_items_packing')}}',
				type: 'GET',
				data: {order_no:order_no,type: type,model_id:model_id,frame_id:frame_id,t_m_w:t_m_w,t_m_b_w:t_m_b_w,t_m_h:t_m_h,tm_sqft:tm_sqft,m_w_c_w:m_w_c_w,m_w_c_b_w:m_w_c_b_w,m_w_c_h:m_w_c_h,frame_size_id:frame_size_id,color_id:color_id,finish_work:finish_work,steel_beeding:steel_beeding,texture_finish:texture_finish,glass_type_id:glass_type_id,hinges:hinges,lock_id:lock_id,finish_work_front:finish_work_front,finish_work_back:finish_work_back,lock_measurement:lock_measurement,hinges_m:hinges_m,color_type:color_type,frame_color_id:frame_color_id,item_remarks:item_remarks,door_thickness:door_thickness},
				success: function(data) {
                    ...
                    $('#tm_sqft').val("0");
                    $('#item_remarks_pop_up').val(" ");
                    $("#door_thickness_popup").val('').trigger('change');
...
$('#m_item_tbl tbody').on('click', '.delete-btn', function() {
    ...
    $.ajax({
				url: '{{route('delete_m_temp_item_packing')}}',
				type: 'GET',
				data: {itemId: itemId},
...
<script>
    ...
    $.ajax({
				url: '{{route('get_list_of_m_items_packing')}}',
				type: 'GET',
				data: {order_no: order_no},
				success: function(response) {
                    // Remove the row from the table if the deletion was successful
...
$(document).ready(function(){
  $("#customer_btn").click(function(){
    ...
    $.ajax({
				url: '{{route('save_customer_details_packing')}}',
				type: 'GET',
...
<script>
  function get_customer_list(){
    ...
    $.ajax({
				url: '{{route('get_customer_list_dynamic_packing')}}',
				success: function(data) {
