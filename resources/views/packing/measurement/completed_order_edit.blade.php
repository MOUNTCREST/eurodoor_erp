...
<form class="form-horizontal"  id="add_measurement_form" name="add_measurement_form" action="{{ route('completed_order_update_packing',$result->id) }}" method="POST" enctype="multipart/form-data">
					@csrf
						<div class="form-body">
    ...
    async function showAlert_confirm(mt_id) {
        ...
        .then((result) => {
            ...
            // mat_finish_pop_up = $("#mat_finish_pop_up").val();
                ...
                $.ajax({
				url: '{{route('completed_order_items_update_packing')}}',
				type: 'GET',
