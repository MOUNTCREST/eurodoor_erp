...
<!-- start main content section -->
						...
						<div class="pX-5 panel w-full">
						  ...
						  <div class="container">
							 <div class="row">
							 <div class="col-sm-12">
							 <form class="form-horizontal"  id="add_journal" name="add_journal" action="{{ url('journal_packing') }}" method="POST" enctype="multipart/form-data" onsubmit="return disableSubmitButton()">
					@csrf
						<div class="form-body">
