...
<div x-data="sorting">
<h5 class="mb-3 text-lg font-semibold dark:text-white-light md:top-[15px] md:mb-0">Assigned List</h5>
                        <div class="panel">
                            ...
                            @foreach($mt_lists as $mt_list)
                                ...
                                <td>{{$no++}}</td>
                                    ...
                                    <div class="flex gap-1 items-center">
                                        <a href="{{ route('production_print_all',$mt_list->mitems_id) }}">
                                            <button type="button" class="btn btn-primary" name="f_print" id="f_print">
                                                PRINT 
                                            </button>
                                        </a>
...
$("#btn_search").click(function () {
     ...
     $.ajax({
       url: '{{route('get_assigned_list_production')}}',
       type: 'GET',
    ...
    const id = value[7];
    const route = "{{ route('print_all', ['id' => ':id']) }}".replace(':id', id);
