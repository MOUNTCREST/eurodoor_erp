...
<div x-data="sorting">
<h5 class="mb-3 text-lg font-semibold dark:text-white-light md:top-[15px] md:mb-0">Completed List</h5>
                        <div class="panel">
                        ...
                        <div class="panel">
                            ...
                            @foreach($mt_lists as $mt_list)
                                ...
                                <td>{{$no++}}</td>
                                    ...
                                    <a href="{{ route('completed_production_view_production', ['id' => $mt_list->id]) }}" class="hover:text-primary">
