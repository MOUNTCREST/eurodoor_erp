...
<div x-data="invoicePreview">
                        ...
                        <div class="mb-6 mt-4 flex flex-wrap items-center justify-center gap-4 lg:justify-center">
                            ...
                            <a href="{{ route('print_production_form_production',$mt_list->mitems_id) }}">
...
<a href="{{ route('print_production_form_sticker_in_production',$mt_list->mitems_id) }}">
...
<a href="{{ route('print_production_frame_sticker_in_production',$mt_list->mitems_id) }}">
                          ...
                          <div class="mb-6 mt-4 flex flex-wrap items-center justify-center gap-4 lg:justify-center">
                          <a href="{{ route('change_assigned_status_in_production',$mt_list->mitems_id) }}">
