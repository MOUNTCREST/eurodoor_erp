...
<!-- start main content section -->
						...
						<h5 class="mb-3 text-lg font-semibold dark:text-white-light md:top-[15px] md:mb-0">Receipt Pending</h5>
                        <div class="pX-5 panel w-full">
						<div class="container">
							 <div class="row">
							 <div class="col-sm-12">
							 <form class="form-horizontal"  id="edit_receipt" name="edit_receipt" action="{{ route('receipt_pending_update',$result->id) }}" method="POST" enctype="multipart/form-data">
					@csrf
						<div class="form-body">
