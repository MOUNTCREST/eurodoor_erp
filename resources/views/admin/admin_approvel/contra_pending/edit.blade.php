...
<!-- start main content section -->
						...
						<h5 class="mb-3 text-lg font-semibold dark:text-white-light md:top-[15px] md:mb-0">Contra Pending</h5>
                        <div class="pX-5 panel w-full">
						<div class="container">
							 <div class="row">
							 <div class="col-sm-12">
							 <form class="form-horizontal"  id="edit_contra" name="edit_contra" action="{{ route('contra_pending_update',$result->id) }}" method="POST" enctype="multipart/form-data">
					@csrf
						<div class="form-body">
							...
							<div class="form-group col-sm-4">
                                ...
                                <div class="form-group col-sm-4">
									<label for="t_date">Date<span style="color: #EB2D30"></span> </label>
										<input type="date" id="t_date" value="{{$result->t_date}}" class="form-input" placeholder="" name="t_date" autocomplete="off">
