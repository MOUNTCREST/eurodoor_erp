...
<div x-data="invoicePreview">
                        ...
                        <a href="{{  route('contra_approve',$result->id)}}" class="btn btn-danger gap-2">
                            ...
                            <a href="{{ route('contra_edit',$result->id) }}" class="btn btn-warning gap-2">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5">
                                    <path
                                        opacity="0.5"
                        ...
                        <div class="panel">
                            <div class="flex flex-wrap justify-between gap-4 px-4">
                                <div class="text-2xl font-semibold uppercase">Contra</div>
                                <div class="shrink-0">
