...
<div x-data="invoicePreview">
                        ...
                        <a href="{{  route('journal_approve',$result->id)}}" class="btn btn-danger gap-2">
                            ...
                            <a href="{{ route('journal_create')}}" class="btn btn-secondary gap-2">
                                <svg
                            ...
                            <a href="{{ route('journal_pending_edit',$result->id) }}" class="btn btn-warning gap-2">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5">
                                    <path
                                        opacity="0.5"
