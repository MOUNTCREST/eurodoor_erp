...
<div x-data="">
<h5 class="mb-3 text-lg font-semibold dark:text-white-light md:top-[15px] md:mb-0">Journal Pending List</h5>
                        <div class="panel">
...
$(document).ready(function() {
    var oTable = $('#myTable').DataTable({
        dom: 'Blfrtip',
        "ajax": {
            "url": "{{route('get_journal_pending_list')}}",
            "dataSrc": ""
        },
        ...
        buttons: [
            {
                extend: 'pdf',
                footer: true,
                title: 'Contra Pending List',
                titleAttr: 'Contra Pending List',
