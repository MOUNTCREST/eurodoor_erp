...
<div x-data="invoicePreview">
                        ...
                        <a href="{{  route('payment_approve_admin',$result->id)}}" class="btn btn-danger gap-2">
                            ...
                            <a href="{{ route('contra_create')}}" class="btn btn-secondary gap-2">
                                <svg
                            ...
                            <a href="{{ route('approvel_payment_pending_edit',$result->id) }}" class="btn btn-warning gap-2">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5">
                                    <path
                                        opacity="0.5"
                        ...
                        <div class="panel">
                            <div class="flex flex-wrap justify-between gap-4 px-4">
                                <div class="text-2xl font-semibold uppercase">Payment</div>
                                <div class="shrink-0">
                            ...
                            <div class="flex flex-col flex-wrap justify-between gap-6 lg:flex-row">
                                ...
                                <div class="flex flex-col justify-between gap-6 sm:flex-row lg:w-2/3">
                                    ...
                                    <div class="mb-2 flex w-full items-center justify-between">
                                            ...
                                            <div>{{$result->reference_no;}}</div>
                                        </div>
                                  
                                      
                                        <div class="mb-2 flex w-full items-center justify-between">
                                            <div class="text-white-dark">From Ledger :</div>
                                            <div>{{$result->account_from;}}</div>
                                        </div> 
                                    ...
                                    <div class="mb-2 flex w-full items-center justify-between">
                                            ...
                                            <div>{{$result->added_date;}}</div>
                                        </div>
                                        <div class="mb-2 flex w-full items-center justify-between">
                                            <div class="text-white-dark">To Ledger :</div>
                                            <div>{{$result->account_to;}}</div>
                                        </div> 
