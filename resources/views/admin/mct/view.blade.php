...
<div x-data="invoicePreview">
                        ...
                        <div class="mb-6 flex flex-wrap items-center justify-center gap-4 lg:justify-end">
                            ...
                            <a href="{{ route('multi_currency_create')}}" class="btn btn-secondary gap-2">
                                <svg
                            ...
                            <a href="{{ route('multi_currency_edit',$result->id) }}" class="btn btn-warning gap-2">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5">
                                    <path
                                        opacity="0.5"
                        ...
                        <div class="panel">
                            <div class="flex flex-wrap justify-between gap-4 px-4">
                                <div class="text-2xl font-semibold uppercase">Multicurrency Transfer</div>
                                <div class="shrink-0">
                            ...
                            <div class="flex flex-col flex-wrap justify-between gap-6 lg:flex-row">
                                <div class="flex-1">
                                    ...
                                    <div class="space-y-1 text-white-dark">
                                        ...
                                        <div class="font-semibold text-black dark:text-white">{{$result->t_no}}</div>
                                    </div>
                                </div>
                                <div class="flex flex-col justify-between gap-6 sm:flex-row lg:w-2/3">
                                    ...
                                    <div class="mb-2 flex w-full items-center justify-between">
                                            ...
                                            <div>{{$result->t_date;}}</div>
                                        </div>
                                       

                                        <div class="mb-2 flex w-full items-center justify-between">
                                            <div class="text-white-dark">From Ledger :</div>
                                            <div>{{$result->account_dr;}}</div>
                                        </div>
                                        <div class="mb-2 flex w-full items-center justify-between">
                                            <div class="text-white-dark">From Amount :</div>
                                            <div>{{$result->from_amount;}}</div>
                                        </div>
                                        <div class="mb-2 flex w-full items-center justify-between">
                                            <div class="text-white-dark">From Currency :</div>
                                            <div>{{$result->from_currency_code;}}</div>
                                        </div>
                                    ...
                                    <div class="xl:1/3 sm:w-1/2 lg:w-2/5">
                                    <div class="mb-2 flex w-full items-center justify-between">
                                            <div class="text-white-dark">To Ledger :</div>
                                            <div>{{$result->account_cr;}}</div>
                                        </div>
                                        <div class="mb-2 flex w-full items-center justify-between">
                                            <div class="text-white-dark">To Amount :</div>
                                            <div>{{$result->to_amount;}}</div>
                                        </div>
                                        <div class="mb-2 flex w-full items-center justify-between">
                                            <div class="text-white-dark">To Currency :</div>
                                            <div>{{$result->to_currency_code;}}</div>
                                        </div>
