...
<!-- start main content section -->
						...
						<!-- <ul class="flex space-x-2 rtl:space-x-reverse">
                            <li>
                                <a href="{{ route('supplier_list')}}" class="text-primary hover:underline">Suppliers</a>
                            </li>
                            <li class="before:content-['/'] ltr:before:mr-1 rtl:before:ml-1">
                                <span><a href="{{ route('supplier_create')}}" class="text-primary hover:underline">Create</a></span>
                            </li>
                        </ul> -->
						...
						<form class="space-y-5"  id="add_supplier" name="add_supplier" action="{{ url('supplier') }}" method="POST" enctype="multipart/form-data" onsubmit="return disableSubmitButton()">
					@csrf
					<div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div>
							...
							<input type="number" id="mobile_no" value="{{old('mobile_no')}}" class="form-input" placeholder="" name="mobile_no" autocomplete="off">
						</div>
						<div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
						<div>
                            ...
                            <textarea
                                        ...
                                        >{{ old('permenant_address') }}</textarea>
						</div>
                        <div>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const myForm = document.getElementById('add_supplier');
