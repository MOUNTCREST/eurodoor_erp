...
<div x-data="invoicePreview">
                        <div class="mb-6 flex flex-wrap items-center justify-center gap-4 lg:justify-end">
                            ...
                            <a href="{{ route('supplier_create')}}" class="btn btn-secondary gap-2">
                                <svg
                            ...
                            <a href="{{ route('supplier_edit',$result->id) }}" class="btn btn-warning gap-2">
                        ...
                        <div class="panel">
                            <div class="flex flex-wrap justify-between gap-4 px-4">
                                <div class="text-2xl font-semibold uppercase">Supplier</div>
                                <div class="shrink-0">
