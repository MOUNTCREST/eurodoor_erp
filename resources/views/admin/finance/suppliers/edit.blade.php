...
<!-- start main content section -->
						...
						<form class="space-y-5"  id="edit_supplier" name="edit_supplier" action="{{ route('supplier_update',$result->id) }}" method="POST" enctype="multipart/form-data">
					@csrf
					<div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
						<div>
						    <label for="supplier_name">Name<span style="color: #EB2D30">*</span> </label>
							<input type="text" id="supplier_name" value="{{old('supplier_name') ? old('supplier_name') : $result->supplier_name}}"  class="form-input" placeholder="" name="supplier_name" autocomplete="off">
										@error('supplier_name')
