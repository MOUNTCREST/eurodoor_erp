...
<!-- start main content section -->
						...
						<!-- <ul class="flex space-x-2 rtl:space-x-reverse">
                            <li>
                                <a href="{{ route('customer_list')}}" class="text-primary hover:underline">Customers</a>
                            </li>
						...
						<form class="space-y-5"  id="add_customer" name="add_customer" action="{{ url('customer') }}" method="POST" enctype="multipart/form-data" onsubmit="return disableSubmitButton()">
					@csrf
...
<script>
       document.addEventListener('DOMContentLoaded', function () {
        ...
        const myForm = document.getElementById('add_customer');
