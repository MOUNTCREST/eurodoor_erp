...
<form class="form-horizontal"  id="add_measurement_form" name="add_measurement_form" action="{{ url('measurement_form') }}" method="POST" enctype="multipart/form-data" onsubmit="return disableSubmitButton()">
					@csrf
						<div class="form-body">
...
<script>
    function get_color_type_and_color_by_model(){
        ...
        $.ajax({
				url: '{{route('get_color_type_and_color_name')}}',
        ...
        type_pop_up = $('#type_pop_up').val();
         ...
         if(type_pop_up == 'Door Only'){
            var largerValue = Math.max(t_m_w_pop_up, t_m_b_w_pop_up);
                ...
                $.ajax({
                url: '{{route('get_top_width_clearence_door_only')}}',
                type: 'GET',
                success: function(response) {

                    wd = response.details.width;
            ...
            // Check which one is larger
                ...
                $.ajax({
                url: '{{route('get_top_width_clearence')}}',
                type: 'GET',
...
function get_details_of_sub_model(){
    sub_model_id = $("#sub_model_pop_up").val();
		...
		$.ajax({
				url: '{{route('get_details_of_sub_model')}}',
				type: 'GET',
            ...
            function get_color_type_details(){
                ...
                $.ajax({
                        url: '{{route('get_color_type_details')}}',
                        type: 'GET',
                        data: {model_id: model_id},
                        success: function(data) {
...
<script>
    function check_items(order_no){
        $.ajax({
				url: '{{route('check_in_measurement_items')}}',
				type: 'GET',
...
<script>
    ...
    <script>
        ...
        $.ajax({
				url: '{{route('save_as_tem_data_m_items')}}',
				type: 'GET',
...
<script>
  function get_customer_list(){
    ...
    $.ajax({
				url: '{{route('get_customer_list_dynamic')}}',
				success: function(data) {
