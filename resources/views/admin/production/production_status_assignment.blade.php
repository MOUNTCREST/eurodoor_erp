...
<!-- start main content section -->
						...
						<form class="space-y-5"  id="assign_order" name="assign_order" action="{{ route('measurement_items_update',$result->id) }}" method="POST" enctype="multipart/form-data">
					@csrf
...
<script>
    ...
    function get_all_die_no_front(){
		...
		$.ajax({
				url: '{{route('get_list_of_die_front_no')}}',
				type: 'GET',
    ...
    function get_all_die_no_back(){
        ...
        $.ajax({
				url: '{{route('get_list_of_die_back_no')}}',
				type: 'GET',
				data: {model_id: model_id,location_id:location_id},
				success: function(data) {
