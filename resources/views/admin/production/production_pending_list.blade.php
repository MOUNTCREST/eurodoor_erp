                        ...
                        <div class="panel">
                            ...
                            @foreach($mt_lists as $mt_list)
								<tr>
                                    ...
                                    <a href="{{ route('assigned_view', ['id' => $mt_list->mitems_id]) }}" class="hover:text-primary">
                                    ...
                                    <button class="btn btn-warning">Assign</button>
                                        ...
                                        <a href="{{ route('assign_frame_only', ['id' => $mt_list->mitems_id]) }}" class="hover:text-primary">
...
$("#btn_search").click(function () {
     ...
     $.ajax({
       url: '{{route('get_production_pending_list')}}',
       type: 'GET',
       data: { delivery_date: delivery_date,fitting_or_packing: fitting_or_packing, root_id: root_id,to_date:to_date},
    ...
    const id = value[7];
    const route = "{{ route('assigned_view', ['id' => ':id']) }}".replace(':id', id);
    ...
    {
    const id = value[7];
    const route = "{{ route('assign_frame_only', ['id' => ':id']) }}".replace(':id', id);
