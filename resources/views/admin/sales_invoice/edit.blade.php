...
<div x-data="invoiceAdd" class="pX-5 panel w-full">
  <form class="form-horizontal"  id="edit_sales_invoice" name="edit_sales_invoice" action="{{ route('sales_invoice_update',$result->account_id) }}" method="POST" enctype="multipart/form-data">
		@csrf
    <div class="mt-8 px-4">
    ...
    <div class="flex flex-col justify-between lg:flex-row">
                                        <div class="mb-6 w-full lg:w-1/2 ltr:lg:mr-6 ">
                                            <div class="mt-3 flex items-center">
                                                ...
                                                <input type="text" name="order_no" id="order_no" value="{{$result->order_no_id}}" readonly="readonly" class="form-input">
                                                                                   
                                              </div>          
                                            </div>
                                            <div class="mb-6 w-full lg:w-1/2 ltr:lg:mr-6 ">
                                            <div class="mt-3 flex items-center">
                                                <label for="due_date_no" class="mb-0 w-1/3 ltr:mr-2 rtl:ml-2">Due Date</label>
                                                <select id="due_date_no" name="due_date_no" class="form-input flex-1">
                                                  <option value="">Select</option>
                                                  @for ($i = 1; $i <= 30; $i++)
                                                          <option value="{{ $i }}" {{ $result->due_date_no == $i ? 'selected' : '' }}>{{ $i; }}</option>
                                                  @endfor
                                              </select>
                                              @error('due_date_no')
                                            ...
                                            <div class="mt-3 flex items-center">
                                                ...
                                                <select id="sale_type" name="sale_type" class="form-input flex-1" onchange="return get_order_no();" readonly="readonly">
                                                  <option value="">Select</option>
                                                  <option value="B To B" {{ $result->sale_type == 'B To B' ? 'selected' : '' }}>B To B</option>
                                                  <option value="B To C" {{ $result->sale_type == 'B To C' ? 'selected' : '' }}>B To C</option>
                                              </select>    
                                              @error('sale_type')
                                                <small class='text-danger'>{{ $message }}</small>
                                              @enderror                                         
    ...
    <div class="flex flex-col justify-between lg:flex-row">
                                        <div class="mb-6 w-full lg:w-1/2 ltr:lg:mr-6 ">
                                            ...
                                            <div class="mt-3 flex items-center">
                                                ...
                                                <input type="text" name="fitting_or_packing" id="fitting_or_packing" value="{{$result->fitting_or_packing}}" readonly="readonly" class="form-input">
                                        ...
                                        <div class="mt-3 flex items-center">
                                                ...
                                                <input type="text" id="s_i_no" value="{{$result->s_i_no}}"  class="form-input flex-1" readonly="readonly" placeholder="" name="s_i_no" autocomplete="off">
                                                @error('s_i_no')
                                                <small class='text-danger'>{{ $message }}</small>
                                              @enderror      
                                        ...
                                        <div class="mb-6 w-full lg:w-1/2 ltr:lg:mr-6 ">
                                            ...
                                            <div class="mt-3 flex items-center">
                                                ...
                                                <input type="date" id="s_date" class="form-input flex-1" value="{{$result->s_date}}" max='<?php echo date("Y-m-d"); ?>' placeholder="" name="s_date" autocomplete="off">
                                                @error('s_date')
                                                  <small class='text-danger'>{{ $message }}</small>
                                                @enderror
                                    ...
                                    <div class="flex flex-col justify-between lg:flex-row">
                                        <div class="mb-6 w-full lg:w-1/2 ltr:lg:mr-6 rtl:lg:ml-6">
                                            ...
                                            <div class="mt-4 flex items-center">
                                                ...
                                                <input type="text" name="customer_name" id="customer_name" value="{{$result->customer_name}}" readonly="readonly" class="form-input">   
                                                <input type="hidden" name="customer_id" id="customer_id" value="{{$result->ledger_id}}" readonly="readonly" class="form-input">                      
 ...
 <div x-data="modal" >
  ...
  <!-- </form>  -->
                                        ...
                                        <option  value="" selected>Select</option>
                                            ...
                                            <option value="{{ $row->id; }}"  {{ $row->id == $result->sales_account_id ? 'selected' : '' }}>{{ $row->ledger; }}</option>
                                            @endforeach
                                        </select>
                                            ...
                                            <thead>
                                                ...
                                                @foreach($s_items as $s_item)
                                                  <tr id="R{{$no++}}">
                                                    ...
                                                    <input type="hidden" name="item_id[]" class="form-input" id="itemid{{$no}}" value="{{ $s_item->item_id }}">
                                                    <input type="text" readonly="readonly" name="item_name[]" class="form-input" id="item_name{{$no}}" value="{{ $s_item->product_name }}">
                                                    </td>
                                                    <td style=" padding: 0.35rem 0.2rem !important;">
                                                      <input type="text" readonly="readonly" class="form-input" name="item_unit_name[]" value="{{$s_item->unit_name}}" autocomplete="off" id="item_unit_name{{$no}}" required="required">
                                                      <input type="hidden" readonly="readonly" class="form-input" value="{{$s_item->item_unit}}" name="item_unit[]" autocomplete="off" id="item_unit{{$no}}">
                                                    </td>
                                                    <td style=" padding: 0.35rem 0.2rem !important;">
                                                      <input type="number" class="form-input qty" name="qty[]" autocomplete="off" id="qty{{$no}}" value="{{$s_item->qty}}" step="0.00001"  oninput="calculate_q_a({{$no}});" required="required">
                                                    </td>
                                                    
                                                    <td style=" padding: 0.35rem 0.2rem !important;">
                                                      <input type="number" class="form-input" name="white_amount[]" autocomplete="off" id="white_amount{{$no}}"  step="0.00001"  value="{{$s_item->white_amount}}" oninput="calculate_all_amount({{$no}});" required="required">
                                                      <input type="hidden" class="form-input white_amount" name="white_amount_qty[]" autocomplete="off" id="white_amount_qty{{$no}}"  step="0.00001"  value="{{$s_item->qty * $s_item->white_amount }}"  >
                                                    </td>
                                                    <td style=" padding: 0.35rem 0.2rem !important;">
                                                      <input type="number" class="form-input" name="gst[]" autocomplete="off" id="gst{{$no}}"  step="0.00001"  value="{{$s_item->gst}}" oninput="calculate({{$no}});" required="required">
                                                      <input type="hidden" class="form-input gst" name="gst_qty[]" autocomplete="off" id="gst_qty{{$no}}"  step="0.00001"  value="{{$s_item->qty * $s_item->gst }}" >
                                                    </td>
                                                    <td style=" padding: 0.35rem 0.2rem !important;">
                                                      <input type="number" class="form-input" name="black_amount[]" autocomplete="off" id="black_amount{{$no}}"  step="0.00001"  value="{{$s_item->black_amount}}"  required="required">
                                                      <input type="hidden" class="form-input black_amount" name="black_amount_qty[]" autocomplete="off" id="black_amount_qty{{$no}}"  step="0.00001"  value="{{$s_item->qty * $s_item->black_amount }}" >
                                                    </td>
                                                    <td style=" padding: 0.35rem 0.2rem !important;">
                                                      <input type="number" class="form-input amount" name="amount[]" autocomplete="off" id="amount{{$no}}"  step="0.00001"   value="{{$s_item->amount}}" oninput="calculate({{$no}});" required="required">
                                                    </td>
...
$(document).ready(function(){
  ...
  // $("#fitting_or_packing").prop("disabled", true);
...
$(document).ready(function(){
  $("#customer_btn").click(function(){
    ...
    $.ajax({
				url: '{{route('save_customer_details')}}',
				type: 'GET',
    ...
    $(document).ready(function () {
      ...
      $('#addBtn').on('click', function () {
        ...
        $('#tbody').append(`<tr id="R${++rowIdx}"><td class="text-center" style=" padding: 0.35rem 0.2rem !important;">${rowIdx}</td>
                                                    ...
                                                    <td style=" padding: 0.35rem 0.2rem !important;">
                                                      <input type="number" class="form-input amount" name="amount[]"  oninput="calculate(${rowIdx});" id="amount${rowIdx}" autocomplete="off"  step="0.00001" >
                                                    </td>
                                                    <td class="text-center" style=" padding: 0.35rem 0.2rem !important;">
                                                    <button type="button" class="remove" >
