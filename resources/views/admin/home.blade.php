 ...
 <!-- <div x-data="chart">
                                ...
                                <div class="perfect-scrollbar relative -mr-3 h-[360px] pr-3">
                                    <div class="space-y-7">
                                        <div class="flex">
                                            ...
                                            <div>
                                                <h5 class="font-semibold dark:text-white-light">
                                                    New project created : <a href="javscript:;" class="text-success">[VRISTO Admin Template]</a>
                                                </h5>
                                        ...
                                        <div class="flex">
                                            ...
                                            <div>
                                                <h5 class="font-semibold dark:text-white-light">
                                                    Task Completed : <a href="javscript:;" class="text-success">[Backup Files EOD]</a>
                                                </h5>
                        ...
                        <div class="mb-6 grid gap-6 sm:grid-cols-3 xl:grid-cols-5">
                            ...
                            <div class="panel h-full p-0">
                                <div class="flex p-5">
                                    <div
                                        class="flex h-11 w-11 items-center justify-center rounded-xl bg-primary/10 text-primary dark:bg-primary dark:text-white-light"
                                    >
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5">
                                            <circle cx="12" cy="6" r="4" stroke="currentColor" stroke-width="1.5" />
                                            <path
                            ...
                            <div class="panel h-full p-0">
                                <div class="flex p-5">
                                    <div
                                        class="flex h-11 w-11 items-center justify-center rounded-xl bg-danger/10 text-danger dark:bg-danger dark:text-white-light"
                                    >
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5">
                                            <path
                            ...
                            <div class="panel h-full p-0">
                                <div class="flex p-5">
                                    <div
                                        class="flex h-11 w-11 items-center justify-center rounded-xl bg-success/10 text-success dark:bg-success dark:text-white-light"
                                    >
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5">
                                            <path
                ...
                <!-- </div> -->
                            ...
                            <div class="mb-6 grid grid-cols-1 gap-6 text-white sm:grid-cols-2 xl:grid-cols-4">
                                ...
                                <div class="panel bg-gradient-to-r from-cyan-500 to-cyan-400">
                                    <div class="flex justify-between">
                                        <div class="text-md font-semibold ltr:mr-1 rtl:ml-1">Pending Orders</div>
                                        <div x-data="dropdown" @click.outside="open = false" class="dropdown">
                                            <a href="javascript:;" @click="toggle">
                                                <svg
                                                    width="24"
                                            ...
                                            >
                                                <li><a href="{{ route('pending_order_list')}}" @click="toggle" >View List</a></li>
                                                
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="mt-5 flex items-center">
                                        <div class="text-3xl font-bold ltr:mr-3 rtl:ml-3">{{ $pending_order_count }}</div>
                                    ...
                                    <div class="mt-5 flex items-center font-semibold">
                                        ...
                                        @php 
                                        $startOrderDate = $pening_order_dates->start_order_date;
                                        $endOrderDate = $pening_order_dates->end_order_date;
                                        @endphp
                                        {{ \Carbon\Carbon::parse($startOrderDate)->format('d-m-Y') }}  TO  {{ \Carbon\Carbon::parse($endOrderDate)->format('d-m-Y') }} 
                                    </div>
                                </div>
                                ...
                                <div class="panel bg-gradient-to-r from-violet-500 to-violet-400">
                                    <div class="flex justify-between">
                                        <div class="text-md font-semibold ltr:mr-1 rtl:ml-1">Confirmed Orders</div>
                                        <div x-data="dropdown" @click.outside="open = false" class="dropdown">
                                            <a href="{{ route('confirmed_order_list')}}" @click="toggle">
                                                <svg
                                                    width="24"
                                                    height="24"
                                                    viewBox="0 0 24 24"
                                            ...
                                            <ul
                                                ...
                                                class="text-black ltr:right-0 rtl:left-0 dark:text-white-dark"
                                            >
                                                <li><a href="javascript:;" @click="toggle">View List</a></li>
                                              
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="mt-5 flex items-center">
                                        <div class="text-3xl font-bold ltr:mr-3 rtl:ml-3">{{ $confirmed_order_count }}</div>
                                        <!-- <div class="badge bg-white/30">- 2.35%</div> -->
                                    </div>
                                    <div class="mt-5 flex items-center font-semibold">
                                        <svg
                                ...
                                <div class="panel bg-gradient-to-r from-blue-500 to-blue-400">
                                    <div class="flex justify-between">
                                        <div class="text-md font-semibold ltr:mr-1 rtl:ml-1">Assigned List</div>
                                        <div x-data="dropdown" @click.outside="open = false" class="dropdown">
                                            <a href="javascript:;" @click="toggle">
                                                <svg
                                                    width="24"
                                            ...
                                            <ul
                                                ...
                                                class="text-black ltr:right-0 rtl:left-0 dark:text-white-dark"
                                            >
                                                <li><a href="{{ route('assigned_list')}}" @click="toggle">View List</a></li>
                                              
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="mt-5 flex items-center">
                                        <div class="text-3xl font-bold ltr:mr-3 rtl:ml-3">{{ $assigned_order_count }}</div>
                                ...
                                <div class="panel bg-gradient-to-r from-fuchsia-500 to-fuchsia-400">
                                    <div class="flex justify-between">
                                        <div class="text-md font-semibold ltr:mr-1 rtl:ml-1">Completed List</div>
                                        <div x-data="dropdown" @click.outside="open = false" class="dropdown">
                                            <a href="{{ route('completed_list')}}" @click="toggle">
                                                <svg
                                                    width="24"
                                                    height="24"
                                                    viewBox="0 0 24 24"
                                    ...
                                    <div class="mt-5 flex items-center">
                                        <div class="text-3xl font-bold ltr:mr-3 rtl:ml-3">{{ $completed_order_count }}</div>
                            ...
                            <div class="grid grid-cols-1 gap-6 xl:grid-cols-2">
                               <!-- Recent Transactions -->
                               <div class="panel">
                                    <div class="mb-5 text-lg font-bold">Recent Sales</div>
                                    <div class="table-responsive">
                                        <table>
                                            <thead>
                                                <tr>
                                                    <th class="ltr:rounded-l-md rtl:rounded-r-md">SL NO</th>
                                                    <th>DATE</th>
                                                    <th>INVOICE NO</th>
                                                    <th>SUPPLIER</th>
                                    
                                                    <th class="text-center ltr:rounded-r-md rtl:rounded-l-md">AMOUNT</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                            @forelse($si_lists as $si_list)
                                                <tr>
                                                    <td class="font-semibold">#{{ $no++ }}</td>
                                                    <td class="whitespace-nowrap">{{ \Carbon\Carbon::parse($si_list->s_date)->format('d-m-Y') }}</td>
                                                    <td class="whitespace-nowrap">{{ $si_list->s_i_no }}</td>
                                                    <td>{{ $si_list->customer_name }}</td>
                                                    <td class="text-center">{{ $si_list->total }}</td>
                                                </tr>
                                            @empty
                                                <tr>
                                                    <td colspan="5" class="text-center">No New data found</td>
                                                </tr>           
                                           @endforelse
                                            </tbody>
                                        </table>
                                ...
                                <!-- Recent Transactions -->
                                <div class="panel">
                                    <div class="mb-5 text-lg font-bold">Recent Purchases</div>
                                    <div class="table-responsive">
                                    <table>
                                            <thead>
                                                <tr>
                                            ...
                                            <tbody>
                                            @forelse($pi_lists as $pi_list)
                                                <tr>
                                                    <td class="font-semibold">#{{ $slno++ }}</td>
                                                    <td class="whitespace-nowrap">{{ \Carbon\Carbon::parse($pi_list->p_date)->format('d-m-Y') }}</td>
                                                    <td class="whitespace-nowrap">{{ $pi_list->p_i_no }}</td>
                                                    <td>{{ $pi_list->supplier_name }}</td>
                                                    <td class="text-center">{{ $pi_list->total }}</td>
                                                </tr>
                                            @empty
                                                <tr>
                                                    <td colspan="5" class="text-center">No New data found</td>
