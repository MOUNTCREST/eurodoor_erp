                        ...
                        <div class="panel">
							<div class="md:absolute md:top-5 ltr:md:left-5 rtl:md:right-5">
                                    <div class="mb-5 flex items-center gap-2">
                                        ...
                                        <a href="{{ route('attendence_create')}}" class="btn btn-primary gap-2">
                                            <svg
                            ...
                            @foreach($at_lists as $at_list)
								<tr>
								    <td>{{$no++}}</td>
                                    <td>{{$at_list->added_date}}</td>
									<td>{{$at_list->total}}</td>
                                    
									<td>
									   <form method="post" action="{{ url('attendence/'.$at_list->id) }}">
                                        @if($at_list->company_id == Session::get('company_id'))

                                    <div class="flex gap-1 items-center">
                                            <a href="{{ route('attendence_edit',$at_list->id) }}" class="hover:text-info">
