...
<div x-data="sorting">
<h5 class="mb-3 text-lg font-semibold dark:text-white-light md:top-[15px] md:mb-0">Currency Balance</h5>
                        <div class="panel">
...
$("#btn_search").click(function () {
     ...
     $.ajax({
       url: '{{route('get_currency_balance')}}',
       type: 'GET',
...
<script>
  function generatePDF() {
    ...
    doc.save('Currrency Balance '+ledger_name+'.pdf');
  }
