...
<div x-data="sorting">
<h5 class="mb-3 text-lg font-semibold dark:text-white-light md:top-[15px] md:mb-0">Employee Report</h5>
                        <div class="panel">
							<div class="md:absolute md:top-5 ltr:md:left-5 rtl:md:right-5">
								...
								<div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
									<div>
									<label for="e_id">Employee<span style="color: #EB2D30"></span> </label>
										<select id="e_id" name="e_id" class="form-input" >
        ...
        if (data[0] === ''){
         ...
         $.each(data, function (key, value) {
            ...
            dr_amnt = value[4]; 
             ...
             sum_blnz = parseFloat(sum_blnz) + parseFloat(prev_balance);
          const newRowData = [value[0],value[1],value[2],value[4],value[3],""+prev_balance.toFixed(3)+""];
          additems(newRowData);
          
         });

         const totalRowData = ['','','<b>Total</b>', '<b>'+sum_cr.toFixed(3)+'</b>', '<b>'+sum_dr.toFixed(3)+'</b>', '<b>'+sum_blnz.toFixed(3)+'</b>'];
