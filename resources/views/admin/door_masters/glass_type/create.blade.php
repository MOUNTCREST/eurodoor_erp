...
<!-- start main content section -->
						...
						<form class="space-y-5"  id="add_glass_type" name="add_glass_type" action="{{ url('glass_type') }}" method="POST" enctype="multipart/form-data">
					@csrf
					<div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
					<div>
						<label for="color_type">Glass Type<span style="color: #EB2D30">*</span> </label>
							<input id="glass_type_name" name="glass_type_name" class="form-input">
