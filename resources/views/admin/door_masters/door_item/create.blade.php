...
<!-- start main content section -->
						...
						<form class="space-y-5"  id="add_door_item" name="add_door_item" action="{{ url('door_item') }}" method="POST" enctype="multipart/form-data">
					@csrf
					...
					<div class="grid grid-cols-1 sm:grid-cols-3 gap-4" style="padding-top: 1%;">
						...
						<select id="color_type" name="color_type" class="form-input">
							...
							<option val="Combo">Combo</option>
							<option val="Triple">Triple</option>
						</select>
						</div>
						...
						<label for="item_name">Item Name<span style="color: #EB2D30">*</span> </label>
							<input type="text" id="item_name" value="{{old('item_name') }}" class="form-input" placeholder="" readonly="readonly" name="item_name" autocomplete="off">
							
						</div>
						<!-- <div>
						<label for="resin_qty">Resin Qty<span style="color: #EB2D30"></span> </label>
						<input type="text" id="resin_qty" name="resin_qty" class="form-input">
						</div> -->
					...
					<div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
						<div id="paint_qty_color_1_div">
							...
							<input type="text" id="paint_qty_color_1"  class="form-input flex-1"  placeholder="" name="paint_qty_color_1" autocomplete="off">
						</div>
						<div id="paint_qty_color_2_div">
						    <label for="paint_qty_color_2">Paint Qty Color 2<span style="color: #EB2D30"></span> </label>
							<input type="text" id="paint_qty_color_2" class="form-input" placeholder="" name="paint_qty_color_2" autocomplete="off">
						</div>
						<div id="paint_qty_color_3_div">
						    <label for="paint_qty_color_3">Paint Qty Color 3<span style="color: #EB2D30"></span> </label>
							<input type="text" id="paint_qty_color_3" class="form-input" placeholder="" name="paint_qty_color_3" autocomplete="off">
						</div>
					</div>
