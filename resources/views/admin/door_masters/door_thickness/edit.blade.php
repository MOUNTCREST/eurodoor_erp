...
<!-- start main content section -->
						...
						<form class="space-y-5"  id="edit_door_thickness" name="edit_door_thickness" action="{{ route('door_thickness_update',$result->id) }}" method="POST" enctype="multipart/form-data">
					@csrf
					<div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
					<div>
						<label for="door_thickness">Thickness<span style="color: #EB2D30">*</span> </label>
							<input id="door_thickness" name="door_thickness" value="{{ $result->door_thickness}}" class="form-input">
