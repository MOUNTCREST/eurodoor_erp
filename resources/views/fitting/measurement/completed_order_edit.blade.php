...
<form class="form-horizontal"  id="add_measurement_form" name="add_measurement_form" action="{{ route('completed_order_update_fitting',$result->id) }}" method="POST" enctype="multipart/form-data">
					@csrf
						<div class="form-body">
    ...
    async function showAlert(mt_id) {
        ...
        .then((result) => {
            if (result.value) {
                ...
                $.ajax({
				url: '{{route('remove_measurement_item_fitting')}}',
				type: 'GET',
				data: {mt_id: mt_id},
    ...
    async function showAlert_confirm(mt_id) {
        ...
        .then((result) => {
            ...
            // mat_finish_pop_up = $("#mat_finish_pop_up").val();
                ...
                $.ajax({
				url: '{{route('completed_order_items_update_fitting')}}',
				type: 'GET',
...
<script>
  ...
  $("#fitting_or_fitting").change(function(){
    fitting_or_fitting = $("#fitting_or_fitting").val();
    $.ajax({
				url: '{{route('generate_order_no_fitting')}}',
				type: 'GET',
				data: {fitting_or_fitting: fitting_or_fitting},
				success: function(data) {
