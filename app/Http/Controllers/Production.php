...
class Production extends Controller
{
    public function production_pending_list(){
		...
		return view('admin.production.production_pending_list',$data)->with('no', 1); 
    ...
    public function assigned_list(){
		...
		$data = ['mt_lists'=> $mt_lists,'root_lists' => $root_lists];
		return view('admin.production.assigned_list',$data)->with('no', 1); 
    }
    ...
    public function assigned_view( string $id ){
        ...
        return view('admin.production.production_status_assignment',compact('result','door_model','locations'));
    }
    ...
    DB::connection('mysql_second')->table('measurement_items')->where('id', $id)
        ...
        return redirect(route('assigned_list'));
    }
  ...
  //   $end_date=  date('Y-m-d', strtotime($t_date));
    ...
    public function print_production_form(String $id){
		...
		$data = ['result'=> $result];
		return view('admin.production.print_production_form',$data)->with('no', 1); 
...
if($result->frame_color_id == 0){
    ...
    $result->frame_color_name = $f_color_names->product_name;
		...
		$data = ['result'=> $result];
		return view('admin.production.print_production_form_sticker',$data)->with('no', 1); 
    }
    public function print_all(String $id){
		...
		return view('admin.production.print_buttons_form',$data)->with('no', 1); 
    }
    public function print_production_frame_sticker(String $id){
		...
		$data = ['result'=> $result];
		return view('admin.production.print_production_frame_sticker',$data)->with('no', 1); 
    }
    ...
    public function pending_list(){
		...
		return view('admin.production.pending_list',$data)->with('no', 1);  
    }
    ...
    public function completed_list(){
		...
		$data = ['mt_lists'=> $mt_lists];
		return view('admin.production.completed_list',$data)->with('no', 1);  
    }
    ...
    public function completed_production_view(String $id){
        ...
        return view('admin.production.completed_production_view',compact('result','m_items'))->with('no', 1);
    }
}
