...
class Contra extends Controller
{
    ...
    public function index()
    {
		...
		return view('white.accounts.contra.index'); 
    }
    public function get_contra_list_white(){
  ...
  foreach ($result as $r) {
    ...
    $viewButton = '<a href="' . route('contra_whiteview',$r->id ) . '">  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-5 h-5">
    <path
        opacity="0.5"
 ...
 $ref_no =$r->reference_no;
  ...
  $result = $query->first();
      ...
      return view('white.accounts.contra.view',compact('result','t_details'))->with('no', 1);
    }
