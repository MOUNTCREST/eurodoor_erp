...
class Contra extends Controller
{
    ...
    {
		return view('packing.accounts.contra.index'); 
    }
public function get_contra_list_packing(){
  ...
  ->where("contras.department", "=",'Packing')
  ->get();
...
foreach ($result as $r) {
  ...
  $editButton = '<a href="' . route('contra_packing_edit',$r->id ) . '"> <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-4.5 h-4.5">
  <path
      opacity="0.5"
...
$btns = '<form method="post" action="'. route('contra_packing_delete', $r->id) .'">'. csrf_field() . method_field('DELETE') .'<div class="flex gap-4 items-center">'.$editButton.$deleteButton.'</div></form>';
...
$ref_no =$r->reference_no;
  ...
  exit();
    ...
    public function create()
    {
        ...
        return view('packing.accounts.contra.create',$data);
    }
    ...
    public function edit(cnta $id)
    {
        ...
        return view('packing.accounts.contra.edit',compact('result','lg_lists_b_c','currency_lists'));
    }
