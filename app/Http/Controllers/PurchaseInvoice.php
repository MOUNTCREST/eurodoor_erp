...
class PurchaseInvoice extends Controller
{
    ...
    public function get_purchase_invoice_list(){
        ...
        ->orderBy("purchase_invoices.p_date","asc")
        ->get();
    ...
    foreach ($result as $r) {
        ...
        $editButton = '<a href="' . route('purchase_invoice_edit',$r->id ) . '"> <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-4.5 h-4.5">
        <path
            opacity="0.5"
    ...
    $viewButton = '<a href="' . route('purchase_invoice_view',$r->id ) . '">  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-5 h-5">
    <path
        opacity="0.5"
    ...
    $btns = '<form method="post" action="'. route('purchase_invoice_delete', $r->account_id) .'">'. csrf_field() . method_field('DELETE') .'<div class="flex gap-4 items-center">'.$editButton.$viewButton.$deleteButton.'</div></form>';
    $date = \Carbon\Carbon::parse($r->p_date)->format('d-m-Y');
    $ref_no ='<a style="color:#1212c1;" href="'. route('purchase_invoice_view', $r->id) .'">'.$r->ref_no.'</a>';
    ...
    public function create()
    {
        ...
        return view('admin.purchase_invoice.create',$data); 
    }
    ...
    public function show(string $id)
    {
        ...
        return view('admin.purchase_invoice.view',compact('result','p_items'))->with('no', 1);
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('admin.purchase_invoice.edit',compact('result','lg_lists','p_a_lists','currency_lists','pt_lists','p_items','supplier_lists'))->with('no', 0);
    }
