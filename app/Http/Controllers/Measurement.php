...
class Measurement extends Controller
{
    ...
    foreach ($result as $r) {
        ...
        $editButton = '<a href="' . route('measurement_form_edit',$r->id ) . '"> <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-4.5 h-4.5">
        <path
            opacity="0.5"
    ...
    $viewButton = '<a href="' . route('measurment_form_view',$r->id ) . '">  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-5 h-5">
    <path
        opacity="0.5"
   ...
   $date = \Carbon\Carbon::parse($r->order_date)->format('d-m-Y') ;
    ...
    public function create()
    {
        ...
        return view('admin.measurement.create',$data)->with('no', 1);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect(route('pending_order_list'));
    }
    ...
    public function show(string $id)
    {
        ...
        return view('admin.measurement.completed_order_view',compact('result','m_items'))->with('no', 1);
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('admin.measurement.edit',compact('result','door_thickness_lists','currency_lists','m_items','customer_lists','executive_lists','model_lists','color_lists','root_lists','gt_lists','lk_lists','fs_lists','single_color_list','brnd_lists'))->with('no', 0);
    ...
    public function update(Request $request, string $id)
    {
        ...
        DB::connection('mysql_second')->table('measurements')->where('id', $id)
            ...
            return redirect(route('confirmed_order_list'));
    }
    ...
    public function confirmed_order_list(){
		...
		return view('admin.measurement.confirmed_order_list'); 
   ...
   $date = \Carbon\Carbon::parse($r->order_date)->format('d-m-Y') ;
    ...
    public function completed_order_edit(string $id){
        ...
        return view('admin.measurement.completed_order_edit',compact('result','m_items','customer_lists','executive_lists','model_lists','color_lists','root_lists','gt_lists','lk_lists','fs_lists'))->with('no', 0);
    }
    ...
    public function measurment_form_view(string $id){
        ...
        return view('admin.measurement.measurment_form_view',compact('result','m_items'))->with('no', 1);
    }
