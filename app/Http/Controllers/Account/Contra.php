...
class Contra extends Controller
{
    ...
    public function index()
    {
		...
		return view('accounts.contra.index'); 
    }
    public function get_contra_list_account(){
      ...
      ->where("contras.department", "=",'Account')
      ->get();
  ...
  foreach ($result as $r) {
      ...
      $editButton = '<a href="' . route('contra_account_edit',$r->id ) . '"> <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-4.5 h-4.5">
      <path
          opacity="0.5"
  ...
  $btns = '<form method="post" action="'. route('contra_account_delete', $r->id) .'">'. csrf_field() . method_field('DELETE') .'<div class="flex gap-4 items-center">'.$editButton.$deleteButton.'</div></form>';
 ...
 $ref_no =$r->reference_no;
    ...
    public function create()
    {
        ...
        return view('accounts.contra.create',$data);
    }
    ...
    public function store(Request $request)
    {
      ...
      'fitting_or_packing.required' => 'The Fitting Or Packing field is required.',
        ...
        return redirect(route('contra_account_list'));
    }
    ...
    public function edit(cnta $id)
    {
        ...
        return view('accounts.contra.edit',compact('result','lg_lists_b_c','currency_lists'));
    }
